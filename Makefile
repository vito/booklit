...
docs/outputs/index.html: docs/lit/*.md docs/html/*.tmpl docs/html/*.md treehighlight/*.go treehighlight/internal/tree_sitter_booklit/*.go treehighlight/internal/tree_sitter_booklit/src/parser.c
