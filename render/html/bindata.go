...
func renderHtmlHeaderTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "render/html/header.tmpl", size: 69, mode: os.FileMode(420), modTime: time.Unix(1589484098, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func renderHtmlQuoteTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "render/html/quote.tmpl", size: 47, mode: os.FileMode(420), modTime: time.Unix(1589484098, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
